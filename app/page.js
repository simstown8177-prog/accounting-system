      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <button className="primary-button" type="button">표준 양식 업로드</button>
            <button className="secondary-button" type="button">월 정산 보기</button>
          </div>
        </div>
      ...
      <section className="content-grid bottom-grid">
        ...
        <article className="surface">
          ...
          <div className="upload-box">
            ...
            <p className="upload-text">엑셀 또는 CSV를 업로드하면 헤더를 검사해 자동으로 누적 장부에 반영하는 영역</p>
            <div className="upload-actions">
              <button className="primary-button" type="button">파일 선택</button>
              <button className="secondary-button" type="button">양식 다운로드</button>
            </div>
          </div>
        </article>
      </section>
